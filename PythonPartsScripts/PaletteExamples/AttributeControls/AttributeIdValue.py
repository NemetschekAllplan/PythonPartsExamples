""" Script for AttributeIdValue control example
"""
...
if TYPE_CHECKING:
    from __BuildingElementStubFiles.AttributeIdValueBuildingElement \
        import AttributeIdValueBuildingElement as BuildingElement  # type: ignore
else:
    from BuildingElement import BuildingElement

print('Load AttributeIdValue.py')
...
def create_preview(_build_ele: BuildingElement,
    ...
    return CreateElementResult(LibraryBitmapPreview.create_library_bitmap_preview( \
                               ...
                               r"Examples\PythonParts\PaletteExamples\AttributeControls\AttributeIdValue.png"))
...
def create_element(build_ele: BuildingElement,
    ...
    element = AttributeIdValue(doc)

    return element.create(build_ele)


class AttributeIdValue():
    """ Definition of class AttributeIdValue
    """

    def __init__(self,
                 doc: AllplanEleAdapter.DocumentAdapter):
        """ Initialization of class AttributeIdValue
