...
def create_preview(_build_ele: BuildingElement,
    ...
    model_ele_list = [AllplanBasisElements.TextElement(com_prop, text_prop, "ElementplanUVS", AllplanGeo.Point2D(0, 100))]
...
def create_element(_build_ele: BuildingElement,
    ...
    Returns:
        created UVS-Elementplan tuple with elements and handles.
    """
...
def modify_control_properties(build_ele, con_props, name, value, doc):
    ...
    if build_ele.Layout.is_modified and build_ele.Layout.selected_value >= 0:
        # Read values from layout
        return True
