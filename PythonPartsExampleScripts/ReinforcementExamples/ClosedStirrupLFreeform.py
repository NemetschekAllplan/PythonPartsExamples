...
class ClosedStirrupFreeform():
    ...
    def create_profile(self):
        ...
        if self.horizontal_placement:
            ...
            profile += AllplanGeo.Point3D(self.topwidth, 0, self.bottomheight)
            profile += AllplanGeo.Point3D(self.topwidth, 0, self.bottomheight + self.topheight)
            profile += AllplanGeo.Point3D(0, 0, self.bottomheight + self.topheight)
            ...
            profile += AllplanGeo.Point3D(self.topwidth, self.bottomheight, 0)
            profile += AllplanGeo.Point3D(self.topwidth, self.bottomheight + self.topheight, 0)
            profile += AllplanGeo.Point3D(0, self.bottomheight + self.topheight, 0)
            profile += AllplanGeo.Point3D(0, 0, 0)
            profile += AllplanGeo.Point3D(self.bottomwidth, 0, 0)
            profile += AllplanGeo.Point3D(self.bottomwidth, self.bottomheight, 0)
        ...
        if self.horizontal_placement:
            ...
            self.handle_list.append(
                HandleProperties("BottomHeight",
                                 AllplanGeo.Point3D(self.bottomwidth, self.placement_length, self.bottomheight),
                                 AllplanGeo.Point3D(self.bottomwidth, self.placement_length, 0),
                                 [("BottomHeight", HandleDirection.z_dir)],
                                 HandleDirection.z_dir,
                                 True))
            self.handle_list.append(
                HandleProperties("TopHeight",
                                 AllplanGeo.Point3D(self.topwidth, self.placement_length, self.bottomheight + self.topheight),
                                 AllplanGeo.Point3D(self.topwidth, self.placement_length, self.bottomheight),
                                 [("TopHeight", HandleDirection.z_dir)],
                                 HandleDirection.z_dir,
                                 True))

            # Handle for Length dimensions
            self.handle_list.append(
            ...
            self.handle_list.append(
                HandleProperties("TopWidth",
                                 AllplanGeo.Point3D(self.topwidth, 0, self.bottomheight + self.topheight),
                                 AllplanGeo.Point3D(0, 0, self.bottomheight + self.topheight),
            ...
            self.handle_list.append(
                HandleProperties("BottomHeight",
                                 AllplanGeo.Point3D(self.bottomwidth, self.bottomheight, self.placement_length),
                                 AllplanGeo.Point3D(self.bottomwidth, 0, self.placement_length),
                                 [("BottomHeight", HandleDirection.y_dir)],
                                 HandleDirection.y_dir,
                                 True))
            self.handle_list.append(
                HandleProperties("TopHeight",
                                 AllplanGeo.Point3D(self.topwidth, self.bottomheight + self.topheight, self.placement_length),
                                 AllplanGeo.Point3D(self.topwidth, self.bottomheight, self.placement_length),
            ...
            self.handle_list.append(
                HandleProperties("TopWidth",
                                 AllplanGeo.Point3D(self.topwidth, self.bottomheight + self.topheight, 0),
                                 AllplanGeo.Point3D(0, self.bottomheight + self.topheight, 0),
                                 [("TopWidth", HandleDirection.x_dir)],
                                 HandleDirection.x_dir,
                                 True))
