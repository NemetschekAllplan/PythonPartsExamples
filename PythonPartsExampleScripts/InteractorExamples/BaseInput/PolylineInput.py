...
class PolylineInput(BaseInteractor):
    ...
    def __init__(self,
        ...
        self.polyline_input = AllplanIFW.PolylineInput(coord_input,
    ...
    def modify_element_property(self,
        ...
        if name == "EnableZCoordinate":
            del self.polyline_input
            self.polyline_input = AllplanIFW.PolylineInput(self.coord_input, value)
