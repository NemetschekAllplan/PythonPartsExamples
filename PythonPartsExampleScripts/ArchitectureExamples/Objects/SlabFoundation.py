"""Example script showing the creation of an architectural slab foundation"""
...
if TYPE_CHECKING:
    from __BuildingElementStubFiles.SlabFoundationBuildingElement import SlabFoundationBuildingElement as BuildingElement  # type: ignore
else:
...
def create_preview(_build_ele: BuildingElement,
    ...
    """Create a simplified slab foundation representation for library preview
...
def create_script_object(build_ele         : BuildingElement,
    ...
    return SlabFoundScript(build_ele, script_object_data)


class SlabFoundScript(BaseScriptObject):
    """Script object that realizes the creation of an architectural slab foundation
    ...
    def __init__(self,
        ...
        self.slab_element             = AllplanArchElements.SlabFoundationElement()
    ...
    @property
    def slab_properties(self) -> AllplanArchElements.SlabFoundationProperties:
        ...
        slab_prop = AllplanArchElements.SlabFoundationProperties()
    ...
    def create_slab_element(self, outline: AllplanGeometry.Polygon2D) -> AllplanArchElements.SlabFoundationElement:
        ...
        self.slab_element = AllplanArchElements.SlabFoundationElement(self.slab_properties, outline)
    ...
    def modify_element_property(self,
        ...
        match name:
            case "TierCount":
                ...
                slab_props = AllplanArchElements.SlabFoundationProperties()
