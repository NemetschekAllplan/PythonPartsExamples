...
if TYPE_CHECKING:
    from __BuildingElementStubFiles.ModifySlabFoundationBuildingElement import ModifySlabFoundationBuildingElement
else:
    ModifySlabFoundationBuildingElement = BuildingElement

print('Load ModifySlabFoundation.py')
...
def create_script_object(build_ele         : BuildingElement,
    ...
    return ModifySlabFoundation(build_ele, script_object_data)

class ModifySlabFoundation(BaseScriptObject):
    """ Definition of class ModifySlabFoundation
    """
    ...
    def __init__(self,
        ...
        self.build_ele                = cast(ModifySlabFoundationBuildingElement, build_ele)
        self.hide_ele_service         = HideElementsService()
        self.slab_element             = AllplanArchEle.SlabFoundationElement()
    ...
    def start_next_input(self):
        ...
        self.slab_element = cast(AllplanArchEle.SlabFoundationElement, AllplanBaseEle.GetElement(self.slab_sel_result.sel_element))
    ...
    def execute(self) -> CreateElementResult:
        ...
        return CreateElementResult(self.create_slab_found_element(),self.create_handles(),
                                   multi_placement = True,
                                   placement_point = AllplanGeo.Point3D())

    def create_slab_found_element(self) -> ModelEleList:
        ...
        slab_props                          = AllplanArchEle.SlabFoundationProperties()
    ...
    def on_cancel_function(self) -> OnCancelFunctionResult:
        ...
        if self.slab_sel_result != SingleElementSelectResult():
            AllplanBaseEle.ModifyElements(self.document, self.create_slab_found_element())
