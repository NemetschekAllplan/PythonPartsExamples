""" Example script for PictureResourceButtonList
"""
...
if TYPE_CHECKING:
    from __BuildingElementStubFiles.PictureResourceButtonListBuildingElement \
        import PictureResourceButtonListBuildingElement as BuildingElement  # type: ignore
else:
    from BuildingElement import BuildingElement

print('Load PictureResourceButtonList.py')
...
def create_preview(_build_ele: BuildingElement,
    ...
    return CreateElementResult(LibraryBitmapPreview.create_library_bitmap_preview( \
                               ...
                               r"Examples\PythonParts\PaletteExamples\ButtonControls\PictureResourceButtonList.png"))
...
def create_script_object(build_ele         : BuildingElement,
    ...
    return PictureResourceButtonList(build_ele, script_object_data)


class PictureResourceButtonList(BaseScriptObject):
    """ Definition of class PictureResourceButtonList
    """
