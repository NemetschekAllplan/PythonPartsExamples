...
if TYPE_CHECKING:
    from AttributeBuildingElement import AttributeBuildingElement as BuildingElement  # type: ignore
else:
...
def create_preview(_build_ele: BuildingElement,
    ...
    return CreateElementResult(LibraryBitmapPreview.create_library_bitmap_preview( \
                               ...
                               r"Examples\PythonParts\PaletteExamples\AttributeControls\Attribute.png"))
