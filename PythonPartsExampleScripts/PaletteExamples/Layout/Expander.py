...
if TYPE_CHECKING:
    from __BuildingElementStubFiles.ExpanderBuildingElement import ExpanderBuildingElement as BuildingElement  # type: ignore
else:
    from BuildingElement import BuildingElement

print('Load Expander.py')
...
def create_preview(_build_ele: BuildingElement,
    ...
    return CreateElementResult(LibraryBitmapPreview.create_library_bitmap_preview( \
                               ...
                               r"Examples\PythonParts\PaletteExamples\Layout\Expander.png"))
...
def create_script_object(build_ele         : BuildingElement,
    ...
    return Expander(build_ele, script_object_data)


class Expander(BaseScriptObject):
