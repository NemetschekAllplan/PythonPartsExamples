<?xml version="1.0" encoding="utf-8"?><Element>
    <Script>
        <Name>ArchitectureExamples\ModifyObjects\ModifyBlockFoundation.py</Name>
        <Title>Modify BlockFoundation</Title>
        <Version>1.0</Version>
    ...
    <Constants>
        ...
        <Constant>
            <Name>BLOCKFOUNDATION_INPUT</Name>
            <Value>3</Value>
            <ValueType>Integer</ValueType>
        </Constant>
    </Constants>
    <Page>
		<Name>Page1</Name>
        <Text>Geometry</Text>
        <Visible>InputMode == BLOCKFOUNDATION_INPUT</Visible>
        <Parameter>
		...
		<Parameter>
            ...
            <Visible>ShapeType == "eRectangular" or ShapeType == "eConical" or ShapeType == "eCircular"</Visible>
        </Parameter>
        <Parameter>
            <Name>Depth</Name>
            <Text>Depth</Text>
